...
const Home = () => {
    ...
    <View style={style.greeting}>
        <Text style = {{fontFamily: "NotoSerifJPSemiBold",fontSize:20,marginTop:50,includeFontPadding:false}}>Welcome back,</Text>
        <Text style = {{fontFamily: "NotoSerifJPSemiBold",fontSize:32,marginTop:0,includeFontPadding:false}}>User</Text>
        <Text style = {{fontFamily: "NotoSerifJPRegular",fontSize:16,marginTop:0,marginBottom:40,includeFontPadding:false}}>Make sure to get some sun!</Text>
        <View style = {globalStyles.deviceContainer}>
            ...
            <View style = {style.single}>
                <Device icon="head-outline" customStyle={{flexGrow:1}} title={"Temperature"} data = {userData.split("^")[1] == null? "Refresh data":userData.split("^")[1]} onPress={() => {
                }} />
            </View>
            <View style = {style.single}>
                <Device icon="heart-outline" customStyle={{flexGrow:1}} title={"BPM"} data = {userData.split("^")[0]} onPress={() => {
                }} />
            </View>
            <View style = {style.single}>
                <Device icon="lungs" customStyle={{flexGrow:1}} title={"Sp02"} data = {userData.split("^")[2] == null? "Refresh data":userData.split("^")[2]} onPress={() => {
                }} />
            </View>
            <Pressable onPress = {() => {
                {console.log("Pressed")}
